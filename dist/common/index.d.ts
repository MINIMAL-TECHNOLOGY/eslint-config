declare const configs: (import("eslint").Linter.FlatConfig | {
    ...
    plugins: {
        ...
        import: import("@typescript-eslint/utils/ts-eslint").Linter.Plugin;
        n: import("@typescript-eslint/utils/ts-eslint").Linter.Plugin;
        promise: import("@typescript-eslint/utils/ts-eslint").Linter.Plugin;
    };
    rules: {
